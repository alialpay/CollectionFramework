...
public class Main{
   ...
   /* list_string.add("Java");
    ...
    list_string.add("Go");
        ...
        Collections.sort(list_string);  //sort alfabetik sıraladı  
    ...
    list_player.add(new Player ("Derya",1));
    list_player.add(new Player ("Gül",10));
    list_player.add(new Player ("Nihal",4));
    
    Player p1 = new Player ("Ali",5);
    Player p2 = new Player ("Nihal",4);
    ...
    treeset.add(new Player ("Derya",1));
    treeset.add(new Player ("Gül",10));
    treeset.add(new Player ("Nihal",4));
